...
public interface FavoriteApi {
    ...
    @Operation(operationId = "addFavorite", summary = "Add favorite.")
    ...
    ResponseEntity<UUID> addFavorite(@RequestParam UUID userId, @RequestParam UUID trainingId);

    @Operation(operationId = "deleteFavorite", summary = "Delete favorite.")
    ...
    ResponseEntity<Boolean> removeFavorite(@RequestParam UUID userId, @RequestParam UUID trainingId);

    @Operation(operationId = "wasIFavorites", summary = "Was I Favorites?")
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "SUCCESS", content = @Content(schema = @Schema(implementation = Boolean.class))),
            @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(schema = @Schema(implementation = Error.class))),
            @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(schema = @Schema(implementation = Error.class))),
            @ApiResponse(responseCode = "403", description = "Forbidden", content = @Content(schema = @Schema(implementation = Error.class))),
    ...
    @GetMapping(value = "/wasIFavorites", produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<Boolean> wasIFavorites(@RequestParam UUID userId, @RequestParam UUID trainingId);

    @Operation(operationId = "getFavoriteCountForTraining", summary = "Get favorite count for training.")
    ...
    @GetMapping(value = "/get/training/{trainingId}", produces = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<Integer> getFavoriteCountForTraining(@PathVariable UUID trainingId);

    @Operation(operationId = "getFavoriteCountForUser", summary = "Get favorite count for user.")
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "SUCCESS", content = @Content(schema = @Schema(implementation = Integer.class))),
            @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(schema = @Schema(implementation = Error.class))),
            @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(schema = @Schema(implementation = Error.class))),
            @ApiResponse(responseCode = "403", description = "Forbidden", content = @Content(schema = @Schema(implementation = Error.class))),
    ...
    ResponseEntity<Integer> getFavoriteCountForUser(@PathVariable UUID userId);
